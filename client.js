...
const Products = [
	new prd_Inventory("Build", 1000, "silver"), new prd_Inventory("Secondary", 9000, "silver"), new prd_Inventory("Main", 2.25, "gold"), new prd_Regen(10, 15000, "silver"), new prd_Regen(30, 7, "gold"),
